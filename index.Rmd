...
```{r}
total_data <- read_csv("~/stat231/blog_aaa/Map_Of_Healthcare/total_data.csv", 
...
```{r}
totalDATA <- read_csv("~/stat231/blog_aaa/Time-Series/totalDATA.csv", show_col_types = FALSE)
...
We draw 30 stratified random samples from combinations of coverage status and sexual orientation due to the limited number of respondents for each combination. The medioids table shows that most individuals who are not covered by health insurance identify as sexual minorities; none of them have college degrees; they have lower income than those insured, except for cluster 6. We observe the interaction of different social categories being in effect when it comes to barriers to health care.
