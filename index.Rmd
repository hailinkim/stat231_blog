...
```{r}
total_data <- read_csv("~/Dropbox/My Mac (MacBook Pro)/Desktop/Multi/blog_aaa/Map_Of_Healthcare/total_data.csv", 
...
```{r}
totalDATA <- read_csv("~/Dropbox/My Mac (MacBook Pro)/Desktop/Multi/blog_aaa/Time-Series/totalDATA.csv", show_col_types = FALSE)
...
Given that Medicare patients still face barriers to care, we use Medicare quality ratings data to examine how to strengthen public insurance. We believe that analyzing reviews for Medicare would help ensure that its beneficiaries are able to access the medical care they need. 
